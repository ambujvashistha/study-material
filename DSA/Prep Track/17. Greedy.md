...
- [Largest number with given sum](https://www.geeksforgeeks.org/problems/largest-number-with-given-sum-1587115620/1)
- [Minimize the sum of product](https://www.geeksforgeeks.org/problems/minimize-the-sum-of-product1525/1)
